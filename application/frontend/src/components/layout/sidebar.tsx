...
import { LayoutDashboard, Users, Bell, Calendar, Sparkles, ArrowLeft, X } from 'lucide-react';
...
export function Sidebar({ mobileOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 bottom-0 w-[260px] bg-[#0D1220] border-r border-[#1E2A45] flex flex-col z-50 transition-transform duration-300 ease-in-out',
      ...
      >
        <div className="p-6 pb-4 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="lg:hidden w-8 h-8 flex items-center justify-center rounded-lg text-[#8B8FA3] hover:text-[#F0F0F5] hover:bg-[#1E2A45]/50 transition-colors"
